...
<body>
	...
	<div class='info'>
		...
		<div class='desc' >
                    ...
                    ?>
                        ...
                        <div><b>Giao thức kết nối</b>: <?php echo $product->getConnectionProtocon() ?></div>
                        <div><b>Có led</b>:
                            <?php
                                if($product->getIsLed()) {
                                        echo "Có";
	...
	<?php
            if(array_key_exists('number', $_POST)) {
                ...
                $listProducts = $guestServices->getListCartProducts($_SESSION['username']);
                if(!in_array($product, $listProducts)){
                            $guestServices->insertProduct($username, $product, $quantity);
                }
            }
	?>
